...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    giveaway: {
      claimReward: AugmentedSubmittable<(round: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      createGiveAway: AugmentedSubmittable<(name: Bytes | string | Uint8Array, startBlock: u32 | AnyNumber | Uint8Array, endBlock: u32 | AnyNumber | Uint8Array, kyc: PalletOcwGiveawayKycStatus | 'Tier0' | 'Tier1' | 'Tier2' | number | Uint8Array, randomType: PalletOcwGiveawayRandomType | 'LocalChain' | 'Babe' | 'ChainLink' | number | Uint8Array, payFee: bool | boolean | Uint8Array, fee: u128 | AnyNumber | Uint8Array, assetType: PalletOcwGiveawayAssetType | 'FungibleToken' | 'NonFungibleToken' | number | Uint8Array, token: Option<PalletOcwGiveawayTokenInfo> | null | Uint8Array | PalletOcwGiveawayTokenInfo | { assetId?: any; amount?: any } | string, nft: Option<PalletOcwGiveawayNftInfo> | null | Uint8Array | PalletOcwGiveawayNftInfo | { collectionId?: any; nftId?: any } | string, maxJoin: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u32, u32, PalletOcwGiveawayKycStatus, PalletOcwGiveawayRandomType, bool, u128, PalletOcwGiveawayAssetType, Option<PalletOcwGiveawayTokenInfo>, Option<PalletOcwGiveawayNftInfo>, u32]>;
      participate: AugmentedSubmittable<(index: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      setBlockResult: AugmentedSubmittable<(blockNumber: u32 | AnyNumber | Uint8Array, requestId: Bytes | string | Uint8Array, result: Vec<U256> | (U256 | AnyNumber | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [u32, Bytes, Vec<U256>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
