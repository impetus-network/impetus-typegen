...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    giveaway: {
      ...
      createGiveAway: AugmentedSubmittable<(name: Bytes | string | Uint8Array, startBlock: u32 | AnyNumber | Uint8Array, endBlock: u32 | AnyNumber | Uint8Array, kyc: PalletOcwGiveawayKycStatus | 'Tier0' | 'Tier1' | number | Uint8Array, randomType: PalletOcwGiveawayRandomType | 'Chainlink' | number | Uint8Array, assetType: PalletOcwGiveawayAssetType | 'FungibleToken' | number | Uint8Array, token: Option<PalletOcwGiveawayTokenInfo> | null | Uint8Array | PalletOcwGiveawayTokenInfo | { assetId?: any; amount?: any } | string, maxJoin: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u32, u32, PalletOcwGiveawayKycStatus, PalletOcwGiveawayRandomType, PalletOcwGiveawayAssetType, Option<PalletOcwGiveawayTokenInfo>, u32]>;
