...
import type { Bytes, Compact, Option, U256, Vec, bool, u128, u32, u64, u8 } from '@polkadot/types-codec';
import type { AnyNumber, IMethod, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, Call, H160, H256, MultiAddress, Permill } from '@polkadot/types/interfaces/runtime';
import type { EthereumTransactionTransactionV2, SpCoreVoid, SpFinalityGrandpaEquivocationProof, SpWeightsWeightV2Weight } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    betting: {
      bet: AugmentedSubmittable<(roundId: H256 | string | Uint8Array, bet: u128 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, u128, u128]>;
      claim: AugmentedSubmittable<(bettorAddress: AccountId32 | string | Uint8Array, roundId: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, H256]>;
      closeRound: AugmentedSubmittable<(roundId: H256 | string | Uint8Array, bet: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, u128]>;
      /**
       * An example dispatchable that takes a singles value as a parameter, writes the value to
       * storage and emits an event. This function must be dispatched by a signed extrinsic.
       **/
      createRound: AugmentedSubmittable<(who: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, id: Bytes | string | Uint8Array, startIn: u32 | AnyNumber | Uint8Array, duration: u32 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array, minBet: u128 | AnyNumber | Uint8Array, maxBet: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, Bytes, u32, u32, u128, u128, u128]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    luckyNumber: {
       ...
       **/
      buyTicket: AugmentedSubmittable<(number: u8 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u8, u128]>;
